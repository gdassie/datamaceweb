		...
		_createClass(FilterableTable, [{
			...
			get: function get() {
				...
				return {
					...
					filterMessage: "Filtre",
					addItemText: "Adicionar",
	...
	var Header = function (_React$Component) {
		...
		_createClass(Header, [{
			...
			value: function render() {
				...
				var filterMessage = this.props.pagersVisible !== false && this.props.pageSizes ? (this.props.filterMessage+ '') : null;	
				var addItemText = this.props.pagersVisible !== false && this.props.pageSizes ? (this.props.addItemText+ '') : null;	
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-5 filter-container' },
							_react2.default.createElement(
								'div',
								{ className: 'filter-container' },
								_react2.default.createElement('input', { type: 'text', className: 'form-control filter-input', value: filter, onChange: this.filterChanged, ref: 'filter', placeholder: filterMessage, autoFocus: this.props.autofocusFilter }),							
								_react2.default.createElement('span', { className: 'input-group-addon bg-info bg-info'},
								_react2.default.createElement('i', { className: 'mdi mdi-magnify text-magnify'})),							
							)	
						),_react2.default.createElement('div',{ className: 'div-container-btn' },_react2.default.createElement('input', {  type: 'button', className: 'btn-adicionar',value: addItemText })),							
